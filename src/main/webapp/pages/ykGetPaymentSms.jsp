	...
	<form id="payment_code_frm" name="payment_code_frm" method="post">
		<table class="tab2" cellpadding="0" border="0" cellspacing="0" >
			...
			<tbody>
				...
				<tr>
					<td align="right"><font color="red">*</font>model：</td>
					<td><input type="text" id="model" name="model" /></td>
				</tr>
				<tr>
					<td align="right"><font color="red">*</font>osversion：</td>
					<td><input type="text" id="osversion" name="osversion" /></td>
				</tr>
				<tr>
					<td align="right"><font color="red">*</font>net：</td>
					<td><input type="text" id="net" name="net" /></td>
				</tr>
				<tr>
					<td align="right"><font color="red">*</font>appversion：</td>
					<td><input type="text" id="appversion" name="appversion" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="right"><font color="red">*</font>appname：</td>
					<td><input type="text" id="appname" name="appname" /></td>
				</tr>
				<tr>
					<td align="right"><font color="red">*</font>subject：</td>
...
"respcode":"0",
"resultMsg":"请求成功",
"mo":{"mo":"taa_a01100015150108U18IFN460032650229136","spnumber":"10669900","send_count":"1"}
}
</pre>
					</td>
				</tr>
