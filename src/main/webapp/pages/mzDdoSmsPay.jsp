...
jQuery(document).ready(function() {
	jQuery("#payment_but").live('click', function(event){
		...
		var _url = _root+"/mzDdo/ddoSmsPay";
...
<body>
	...
	<div class="nav_left">
		<a href="<%=request.getContextPath()%>/api/mzDdoGetSms" >获取验证码接口</a>
		<a href="<%=request.getContextPath()%>/api/mzDdoSmsPay" id="current_nav">验证码支付接口</a>
	</div>
