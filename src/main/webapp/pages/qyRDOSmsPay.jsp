...
jQuery(document).ready(function() {
	jQuery("#payment_but").live('click', function(event){
		...
		var _url = _root+"/qy/rdoSmsVerify";
...
<body>
	...
	<div class="nav_left">
		<a href="<%=request.getContextPath()%>/api/qyRDOGetSms">获取短信内容接口</a>
		<a href="<%=request.getContextPath()%>/api/qyRDOSmsPay" id="current_nav">短信验证支付接口</a>
	</div>
	
	<div class="api_from_div">
		<jsp:include page="qyRDOSmsPayBase.jsp" />
