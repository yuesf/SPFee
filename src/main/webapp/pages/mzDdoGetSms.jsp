...
jQuery(document).ready(function() {
	jQuery("#payment_but").live('click', function(event){
		...
		var _url = _root+"/mzDdo/getDdoPaySms";
...
<body>
	...
	<div class="nav_left">
		<a href="<%=request.getContextPath()%>/api/mzDdoGetSms" id="current_nav">获取验证码接口</a>
		<a href="<%=request.getContextPath()%>/api/mzDdoSmsPay" >验证码支付接口</a>
	</div>
	
	<div class="api_from_div">
		<jsp:include page="mzDdoGetSmsBase.jsp" />
