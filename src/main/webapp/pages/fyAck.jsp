		...
		<form id="payment_code_frm" name="payment_code_frm" method="post">
			<table class="tab2" cellpadding="0" border="0" cellspacing="0">
				...
				<tbody>
					...
					<tr>
						<td align="right"><font color="red">*</font>minute：</td>
						<td><input type="text" id="minute" name="minute" /></td>
					</tr>
					...
					<tr>
						<td align="right"><font color="red">*</font>pid：</td>
						<td><input type="text" id="pid" name="pid" /></td>
					</tr>

					<tr>
						<td align="right"><font color="red">*</font>stime：</td>
						<td><input type="text" id="stime" name="stime" /></td>
					</tr>
					
					<tr>
						<td align="right"><font color="red">*</font>etime：</td>
