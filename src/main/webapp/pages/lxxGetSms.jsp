...
<body>
	...
	<div class="nav_left">
		<a href="<%=request.getContextPath()%>/api/lxxGetSms" id="current_nav">获取验证码接口</a>
		<a href="<%=request.getContextPath()%>/api/lxxSmsPay" >验证码支付接口</a> 
	</div>
	
	<div class="api_from_div">
		<jsp:include page="lxxGetSmsBase.jsp" />
