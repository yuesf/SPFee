...
<body>
	...
	<div class="nav_left">
		<a href="<%=request.getContextPath()%>/api/xrGetSms" id="current_nav">获取短信内容接口</a>
	</div>
	
	<div class="api_from_div">
		<jsp:include page="xrGetSmsBase.jsp" />
		...
		<table class="tab3" cellpadding="0" border="0" cellspacing="0" style="margin-bottom: 20px;" >
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="3">
<pre>
{” resultCode”:”0”,” resultMsg”:”xxxx” , ”orderId”:”XXX”, smsContent”:”XXX”}
</pre>
					</td>
				</tr>
