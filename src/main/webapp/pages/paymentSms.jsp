...
jQuery(document).ready(function() {
	...
	jQuery("#payment_but").live('click', function(event){
		...
		var _url = _root+"/iread/getPaySms";
...
<body>
	...
	<div class="nav_left">
		<a href="<%=request.getContextPath()%>/api/paymentSms" id="current_nav">获取支付短信接口</a>
	...
	<form id="payment_code_frm" name="payment_code_frm" method="post">
		<table class="tab2" cellpadding="0" border="0" cellspacing="0" >
			...
			<tbody>
				<tr>
					<td align="right"><font color="red">*</font>command：</td>
					<td><input type="text" id="command" name="command" maxlength="2" /></td>
				</tr>
				<tr>
					<td align="right"><font color="red">*</font>serviceId：</td>
...
"resultCode":"0",
"resultMsg":"请求成功",
"sms":"111860000057192314372998438293490796897142231684459a377fefb97f5b000",
