...
jQuery(document).ready(function() {
	jQuery("#payment_but").live('click', function(event){
		...
		var _url = _root+"/mz/getPaySmsForPc";
...
<body>
	...
	<div class="nav_left">
		<a href="<%=request.getContextPath()%>/api/mzGetSms" id="current_nav">获取验证码接口</a>
		<a href="<%=request.getContextPath()%>/api/mzSmsPay" >验证码支付接口</a>
	</div>
	
	<div class="api_from_div">
		<jsp:include page="mzGetSmsBase.jsp" />
	...
	<form id="get_code_frm" name="get_code_frm" method="post">
		<table class="tab2" cellpadding="0" border="0" cellspacing="0" >
			...
			<tbody>
				...
				<tr>
					<td align="right"><font color="red">*</font>channelcode：</td>
					<td><input type="text" id="channelcode" name="channelcode" /></td>
				</tr>
