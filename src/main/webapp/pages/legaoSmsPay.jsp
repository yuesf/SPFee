...
<body>
	...
	<div class="nav_left">
		<a href="<%=request.getContextPath()%>/api/mgDdoGetSms" >获取验证码接口</a>
		<a href="<%=request.getContextPath()%>/api/mgDdoSmsPay" id="current_nav">验证码支付接口</a>
	</div>
