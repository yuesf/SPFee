...
<body>
	...
	<div class="nav_left">
		<a href="<%=request.getContextPath()%>/api/qyRDOGetSms" id="current_nav">获取短信内容接口</a>
		<a href="<%=request.getContextPath()%>/api/qyRDOSmsPay">短信确认支付接口</a>
	</div>
	
	<div class="api_from_div">
		<jsp:include page="qyRDOGetSmsBase.jsp" />
