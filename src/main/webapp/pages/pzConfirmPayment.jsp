...
jQuery(document).ready(function() {
	...
	jQuery("#payment_but").live('click', function(event){
		...
		var _url = _root+"/pzweb/confirmPayment";
...
<body>
	...
	<div class="nav_left">
		<a href="<%=request.getContextPath()%>/api/pzGetPaymentSms" id="current_nav">获取支付验证码接口</a>
		<a href="<%=request.getContextPath()%>/api/pzConfirmPayment">确认支付接口</a>
	</div>
	...
	<form id="payment_code_frm" name="payment_code_frm" method="post">
		<table class="tab2" cellpadding="0" border="0" cellspacing="0" >
			...
			<tbody>
				...
				<tr>
					<td align="right"><font color="red">*</font>paymentCodesms：</td>
					<td><input type="text" id="paymentCodesms" name="paymentCodesms" /></td>
				</tr>
