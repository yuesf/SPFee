...
jQuery(document).ready(function() {
	...
	jQuery("#payment_but").live('click', function(event){
		...
		var _url = _root+"/pzwostore/paymentAck";
...
<body>
	...
	<div class="nav_left">
		<a href="<%=request.getContextPath()%>/api/pzWoStoreGetPayment" id="current_nav">获取支付短信</a>
		<a href="<%=request.getContextPath()%>/api/pzWoStoreAckTest">确认回调</a>
	</div>
	...
	<form id="payment_code_frm" name="payment_code_frm" method="post">
		<table class="tab2" cellpadding="0" border="0" cellspacing="0" >
			...
			<tbody>
				...
				<tr>
					<td align="right"><font color="red">*</font>mo：</td>
					<td><input type="text" id="mo" name="mo" /></td>
				</tr>
				<tr>
					<td align="right"><font color="red">*</font>port：</td>
				...
				<tr>
					<td align="right"><font color="red">*</font>time：</td>
				...
				<tr>
					<td align="right"><font color="red">*</font>price：</td>
